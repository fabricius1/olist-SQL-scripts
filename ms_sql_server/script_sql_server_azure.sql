...
CREATE MASTER KEY ENCRYPTION BY PASSWORD = 'change this for a strong password';

CREATE DATABASE SCOPED CREDENTIAL MyAzureBlobStorageCredential 
WITH IDENTITY = 'SHARED ACCESS SIGNATURE',
SECRET = 'PUT_SAS_KEY_HERE';

CREATE EXTERNAL DATA SOURCE MyAzureBlobStorage
WITH (	
  TYPE = BLOB_STORAGE,
  -- CHANGE storageaccount BELOW FOR YOUR STORAGE ACCOUNT NAME: 
  LOCATION = 'https://storageaccount.blob.core.windows.net/1-raw/olist/csv_files', 
